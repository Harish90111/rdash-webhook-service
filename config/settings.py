...
WEBHOOK_CIRCUIT_BREAKER_FAILURE_THRESHOLD = env_int(
    "WEBHOOK_CIRCUIT_BREAKER_FAILURE_THRESHOLD",
    5,
    minimum=1,
)
WEBHOOK_CIRCUIT_BREAKER_RECOVERY_TIMEOUT_SECONDS = env_int(
    "WEBHOOK_CIRCUIT_BREAKER_RECOVERY_TIMEOUT_SECONDS",
    60,
    minimum=1,
)
